...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' 'unsafe-eval' data: blob:; connect-src 'self' <%= backendUrlForCsp %> http://localhost:8080 https://nominatim.openstreetmap.org; script-src 'self' 'unsafe-inline' 'unsafe-eval';">
</head>
<body>
        <div class="header">
