    ...
    <script>
        ...
        async function loadData() {
            try {
                ...
                const vehiclesUrl = API_BASE_URL + '/api/vehicles/user/' + userId;
                
                // Charger les stations, les lieux et les véhicules en parallèle
                // Utiliser authenticatedFetch pour les véhicules car c'est une donnée privée
                const fetchPromises = [
                ...
                if (userId) {
                    fetchPromises.push(authenticatedFetch(vehiclesUrl));
                } else {
